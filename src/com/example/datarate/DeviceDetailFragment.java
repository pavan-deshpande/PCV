...
//                        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d(DataRateActivity.TAG, "File in Device Detail");
        TextView statusText = (TextView) mContentView.findViewById(R.id.status_text);
        statusText.setText("Sending: " + uri);
        Log.d(DataRateActivity.TAG, "Intent----------- " + uri);
    ...
    public static class FileServerAsyncTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            try {
                ...
                Log.d(DataRateActivity.TAG, "Server: Socket opened");
                Socket client = serverSocket.accept();
                long start = System.currentTimeMillis();
                Log.d(DataRateActivity.TAG, "Server: connection done");
                ...
                Log.d(DataRateActivity.TAG, "server: copying files " + f.toString());
                InputStream inputstream = client.getInputStream();
                copyFile(inputstream, new FileOutputStream(f));
                serverSocket.close();
                long end = System.currentTimeMillis();
                DataRateDAO dao = new DataRateDAO(context);
